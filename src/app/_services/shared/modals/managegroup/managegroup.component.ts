...
export class ManagegroupComponent implements OnInit,AfterViewInit,OnDestroy {
  ...
  constructor(public activeModal: NgbActiveModal,private apiService:ApiService,
              private groupService:GroupService,private route:ActivatedRoute,private modalService: NgbModal) { }
  ...
  ngAfterViewInit(){
    ...
    combineLatest(this.groupGet$,this.membersGet$).pipe(takeUntil(this.destroyed$)).subscribe(([group,members])=>{this.title=group['groups'][0]['title']
