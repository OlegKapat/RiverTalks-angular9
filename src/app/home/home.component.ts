...
import { LoadimageonserverComponent } from '../_services/shared/modals/loadimageonserver/loadimageonserver.component';
import { SendfilesinchatComponent } from '../_services/shared/modals/sendfilesinchat/sendfilesinchat.component';
...
export class HomeComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    this.route.queryParamMap.subscribe((param) => {
      this.selected = param["params"].select;
    });
